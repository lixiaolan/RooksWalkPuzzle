...
PuzzleBook::PuzzleBook(vector<string> files, string a, vector<string> b, vector<string> c,vector<string> d, int e): bookTitle(a), chapterTitles(b), beforeImages(c), afterImages(d), pi(e) {
  puzzleIndex = &pi;
